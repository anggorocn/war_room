...
class Kinerja_korporat_tabel extends REST_Controller {
	...
	function index_get() {
        ...
        $tawal= (int)$tawal;
        $takhir= (int)$takhir;
        // $url= "pbrdb/tabel_nko?tahunawal=2023&tahunakhir=2024";
        $url= "pbrdb/tabel_nko?tahunawal=".$tawal."&tahunakhir=".$takhir;
        // echo $url;exit;
        $arrparam= ["vurl" => $url];
