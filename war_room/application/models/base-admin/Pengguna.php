...
class Pengguna extends Entity { 
    ...
    function insert()
    {
    	...
    	(
    		PENGGUNA_ID, USERNAME, NAMA, STATUS, PERUSAHAAN_ID, ROLE_ID,PENGGUNA_INTERNAL_ID,TIPE,PENGGUNA_EXTERNAL_ID,PASS,AUTO_CONNECT
    	)
    	VALUES 
    	(
	...
	function update()
	{
		...
		, AUTO_CONNECT= ".$this->getField("AUTO_CONNECT")."
	...
	function insertPenggunaPageHakAkses()
    {
    	$this->setField("PENGGUNA_PAGE_HAK_AKSES_ID", $this->getNextId("PENGGUNA_PAGE_HAK_AKSES_ID","PENGGUNA_PAGE_HAK_AKSES"));

    	$str = "
    	INSERT INTO PENGGUNA_PAGE_HAK_AKSES
    	(
    		PENGGUNA_PAGE_HAK_AKSES_ID, PENGGUNA_ID, PENGGUNA_PAGE_HAK_ID
    	)
    	VALUES 
    	(
	    	'".$this->getField("PENGGUNA_PAGE_HAK_AKSES_ID")."'
	    	, '".$this->getField("PENGGUNA_ID")."'
	...
	function deletePenggunaPageHakAkses()
	{
		$str = "
		DELETE FROM PENGGUNA_PAGE_HAK_AKSES
		WHERE 
		PENGGUNA_ID = '".$this->getField("PENGGUNA_ID")."'"; 
	...
	// 			, F.DISTRIK_NAMA_INFO
	// 			, F.STATUS_ALL_INFO
	// 			, G.PENGGUNA_PAGE_HAK_INFO
	// 			, G.PENGGUNA_PAGE_HAK_NAMA_INFO
	// 			, A.AUTO_CONNECT
	// 		FROM PENGGUNA A
	// 		LEFT JOIN 
	// 		(
	...
	// 		(
	// 			SELECT B.PENGGUNA_ID
	// 			,STRING_AGG(A.PENGGUNA_PAGE_HAK_ID::text, ', ') AS PENGGUNA_PAGE_HAK_INFO
	// 			,STRING_AGG(A.NAMA_HAK, ', ') AS PENGGUNA_PAGE_HAK_NAMA_INFO 
	// 			FROM PENGGUNA_PAGE_HAK A
	// 			INNER JOIN PENGGUNA_PAGE_HAK_AKSES B ON B.PENGGUNA_PAGE_HAK_ID = A.PENGGUNA_PAGE_HAK_ID 
	// 			GROUP BY B.PENGGUNA_ID
	// 		) G ON G.PENGGUNA_ID = A.PENGGUNA_ID
