...
class Users extends Entity{
  ...
  function selectByIdPersonal($id_usr,$passwd)
  {
    $str = "
    SELECT
    A.*,c.kode_hak kode_page_hak,c.pengguna_page_hak_id
    FROM pengguna A
    left join pengguna_page_hak_akses b on b.pengguna_id = a.pengguna_id
    left join pengguna_page_hak c on c.pengguna_page_hak_id = b.pengguna_page_hak_id
    WHERE 1=1
