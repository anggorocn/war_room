...
class OutliningAssessment extends Entity { 
    ...
    function insert()
    {
    	...
    	(
    		OUTLINING_ASSESSMENT_ID,DISTRIK_ID,BLOK_UNIT_ID,UNIT_MESIN_ID,BULAN,TAHUN,STATUS,LAST_CREATE_USER,LAST_CREATE_DATE,V_STATUS
    	)
    	VALUES 
    	(
	...
	function insertdetil()
    {
    	...
    	(
    		OUTLINING_ASSESSMENT_DETIL_ID,OUTLINING_ASSESSMENT_ID,LIST_AREA_ID,ITEM_ASSESSMENT_DUPLIKAT_ID,AREA_UNIT_ID,AREA_UNIT_DETIL_ID,LAST_CREATE_USER,LAST_CREATE_DATE
    	)
    	VALUES 
    	(
	...
	function selectByParamsRekomendasiDistrik($paramsArray=array(),$limit=-1,$from=-1, $statement='', $sOrder="ORDER BY OUTLINING_ASSESSMENT_ID ASC")
	{
		$str = "
		SELECT 
		A.*,C.DISTRIK_ID,C.NAMA DISTRIK_NAMA,D.BLOK_UNIT_ID,D.NAMA BLOK_NAMA,E.UNIT_MESIN_ID,E.NAMA UNIT_NAMA
		FROM OUTLINING_ASSESSMENT A
	...
	{
		$str = "
		SELECT  SUM (A.PERSEN)/ SUM(A.TOTAL)  PERC_AREA FROM
		(
