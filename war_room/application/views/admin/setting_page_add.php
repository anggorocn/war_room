...
else
{
    ...
    $statement = " AND PENGGUNA_PAGE_HAK_ID = '".$reqId."' ";
    $set->selectByParams(array(), -1, -1, $statement);
    // echo $set->query;exit;
    $set->firstRow();
    $reqId= $set->getField("PENGGUNA_PAGE_HAK_ID");
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                                    ...
                                    data-options="width:'300',editable:false,valueField:'id',textField:'text',url:'json-admin/Combo_json/combostatusaktif'" value="<?=$reqDeskripsi?>" required /> -->
                    ...
                    <div class="box-body table-height">
                        <table class="table table-hover table-sticky">
                            <thead>
                                <tr>
                                    <th style="vertical-align: top;" class="tdcenter" rowspan="2" width="600px">Page</th>
                                    <th style="vertical-align: top;" class="tdcenter" rowspan="2" width="10px">
                                        Menu<br/>
                                        <input id="reqRadioHeadCheck-menu" type="checkbox" />
                                    </th>
                                    <th class="tdcenter" colspan="3" width="10px">Read</th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th class="tdcenter" colspan="3">Read</th>
