...
<head>
    ...
    <title>Admin | PT PLN Nusantara Power</title>
    <base href="<?=base_url();?>" />
...
<body>
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block <? if($pg == "" || $pg == "home"|| $pg == "home_logsheet"|| $pg == "home_pemeliharaan"){?>active<? } ?>">
                    <a href="app/" class="nav-link"><i class="fa fa-home" aria-hidden="true"></i> Dashboard</a>
                </li>
            </ul>
                ...
                function getmenubyparent($infoid, $arrMenu, $infolinkmodul)
                {
                    ...
                    foreach ($arrayKey as $valkey => $indexkey) 
                    {
                        ...
                        if($infolinkmodul == $infolink)
                            $infoactive= "active";
                ?>
                    <a class=" <?=$infoactive?>" href="admin/index/<?=$infolink?>"><?=$infonama?></a>
                <?
                    }
                }
                ?>
    ...
    function openAdd(pageUrl) {
        eModal.iframe(pageUrl, 'PT PLN NP')
    }
    function openCabang(pageUrl) {
        eModalCabang.iframe(pageUrl, 'PT PLN NP')
    }
    function closePopup() {
        eModal.close();
    }
