...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "PENGGUNA_PAGE_HAK_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "admin/index/setting_page_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "admin/index/setting_page_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
            if (r){
                $.getJSON("json-admin/page_json/delete/?reqId="+valinfoid,
                    function(data){
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-admin/page_json/json?reqPencarian="+reqPencarian;
        datanewtable.DataTable().ajax.url(jsonurl).load();
	});

    $('#btnImport').on('click', function () {
        openAdd("admin/index/master_crud_import");
    });
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-admin/page_json/json";
