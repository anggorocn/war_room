...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="admin/index/<?=$pgreturn?>">Data <?=$pgtitle?></a> &rsaquo; Reset Password User Eksternal</div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">  
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                                     <input autocomplete="off" class="easyui-validatebox textbox form-control" type="text" name="reqUsername"  id="reqUsername" value="<?=$reqUsername?>" style="width:100%" disabled/>
                                </div>
                            </div>
                        </div>
                    </div>
...
function submitForm(){
    ...
    $('#ff').form('submit',{
        url:'json-admin/pengguna_json/reset_password',
        onSubmit:function(){
