...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "admin/index/master_pengguna_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "admin/index/master_pengguna_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });

    $('#btnImport').on('click', function () {
        openAdd("admin/index/master_pengguna_import");
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
            if (r){
                $.getJSON("json-admin/pengguna_json/delete/?reqId="+valinfoid,
                    function(data){
    ...
    $("#btnReset").on("click", function () {
        ...
        varurl= "admin/index/master_pengguna_reset?reqId="+valinfoid;
        document.location.href = varurl;
    });
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-admin/pengguna_json/json?reqPencarian="+reqPencarian;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-admin/pengguna_json/json";
