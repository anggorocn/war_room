                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                      <div class="area-info-target">
                                        <h4>Status MoU</h4>
                                        <div class="inner">
                                          <div class="item sudah-memenuhi-target" style="padding-bottom: 20px;text-align:center;">
  ...
  function RekapMou(tipe,search){
      ...
      $.ajax({
          ...
          success : function(text) {
            ...
            // console.log(text);
            $('#table-bdd').html(text['table-bdd']);
            $('#table-bdg').html(text['table-bdg']);
