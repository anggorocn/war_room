            ...
            <div class="col-md-12">
                <div class="area-wrapper">
                                      ...
                                      <div class="grafik-donut" id="grafik-pie-kinerja-korporat"></div>
                                        <div class="caption" style="margin: 0px 100px;">
                                            <table style="width:100%;">
                                                <tr>
                                                    <td style="text-align:left;height: 5px;"><i class="fa fa-circle" aria-hidden="true" style="color:gray"></i> Belum Ada Progress</td>
                                                    <td style="height: 5px;" id='id-StatusBelumAdaProgress'>0</td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align:left;height: 5px;"><i class="fa fa-circle" aria-hidden="true" style="color:red"></i> Development</td>
                                                    <td style="height: 5px;" id='id-StatusDevelopment'>0</td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align:left;height: 5px;"><i class="fa fa-circle" aria-hidden="true" style="color:skyblue;"></i> GRC</td>
                                                    <td style="height: 5px;" id='id-StatusGRC'>0</td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align:left;height: 5px;"><i class="fa fa-circle" aria-hidden="true" style="color:blue"></i> KKP oleh PLN</td>
                                                    <td style="height: 5px;" id='id-StatusKKPolehPLN'>0</td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align:left;height: 5px;"><i class="fa fa-circle" aria-hidden="true" style="color:darkgreen;"></i> Konstruksi</td>
                                                    <td style="height: 5px;" id='id-StatusKonstruksi'>0</td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align:left;height: 5px;"><i class="fa fa-circle" aria-hidden="true" style="color:pink;"></i> Pre-FS / FS</td>
                                                    <td style="height: 5px;" id='id-StatusPreFS'>0</td>
                                                </tr>
                                                <tr>
                    ...
                    <div class="area-sumber-data detil">
                        <label>Sumber data : <span>BDG</span></label>
  ...
  function KinerjaKorporat(val){
    $.ajax({
        ...
        success : function(text) {
            ...
            $('#id-StatusKonstruksi').html(text["StatusKonstruksi"]);
