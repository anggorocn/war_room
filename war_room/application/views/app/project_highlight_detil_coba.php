                                    ...
                                    <li class="selected" data-date="16/01/2014">
                                      <div class="slider-for">
                                        <div>
                                          ...
                                          <div class="col-md-6"> 
                                            <div class="slick-slide" data-slick-index="1" aria-hidden="true" style="" tabindex="-1">
                                              <div class="bs-overlay foto">
                                                  <input type="hidden" id="dthiddenmediaurl16_04_2024_1" value="http://cdn.plnnusantarapower.co.id/proxycors_media.php?b64url=aHR0cDovL3ByaW1lLnBsbm51c2FudGFyYXBvd2VyLmNvLmlkL2ZpbGVzL2Rva3VtZW50YXNpL2ltYWdlLzU2MTQ4ZmExNzQ1ODI2ZjU4ZTVjNTM0Y2EwNjQ1OGNiLmpwZw==" tabindex="-1">
                                                  <img onclick="vhrefimg(`16_04_2024_1`)" id="vhrefimg16_04_2024_1" alt="Owner Camp" src="http://cdn.plnnusantarapower.co.id/proxycors_media.php?b64url=aHR0cDovL3ByaW1lLnBsbm51c2FudGFyYXBvd2VyLmNvLmlkL2ZpbGVzL2Rva3VtZW50YXNpL2ltYWdlLzU2MTQ4ZmExNzQ1ODI2ZjU4ZTVjNTM0Y2EwNjQ1OGNiLmpwZw==">
                                          ...
                                          <div class="col-md-6"> your content1 desc</div>    
                                          </div>
                                        </div>
                                        <div>
                                          <div class="row" style="margin: 20px">
                                          <div class="col-md-6"> <img src="https://assets.promediateknologi.id/crop/0x0:0x0/750x500/webp/photo/2023/08/09/IMG_4791-1712285770.jpeg" style="height:200px"></div>    
                                          <div class="col-md-6"> your content2 desc</div>    
                                          </div>
                                        </div>
                                        <div>
                                          <div class="row">
                                          <div class="col-md-6"> your content3</div>    
                                          <div class="col-md-6"> your content3 desc</div>    
                                          </div>
                                        </div>
                                        <div>
                                          <div class="row">
                                          <div class="col-md-6"> your content4</div>    
                                          <div class="col-md-6"> your content4 desc</div>    
                                          </div>
                                        </div>
                                        <div>
                                          <div class="row">
                                          <div class="col-md-6"> your content5</div>    
                                          <div class="col-md-6"> your content5 desc</div>    
                                          </div>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-6">
                                          <div class="slider-nav">
                                            <div>
                                              <img src="https://cdn.idntimes.com/content-images/community/2023/02/whatsapp-image-2023-02-26-at-91255-am-770cbc2889bb4c14bf5042be7b505d5d-28528a7c990a96ed633f7ec280847476_600x400.jpeg" style="height:50px;margin: auto;"> 
                                            </div>
                                            <div>
                                              <img src="https://cdn.idntimes.com/content-images/community/2023/02/whatsapp-image-2023-02-26-at-91255-am-770cbc2889bb4c14bf5042be7b505d5d-28528a7c990a96ed633f7ec280847476_600x400.jpeg" style="height:50px;margin: auto;"> 
                                            </div>
                                    ...
                                    <li class="selected" data-date="28/02/2014">
                                      <div class="slider-for1">
                                        <div>
                                          <div class="row" style="margin: 20px">
                                          <div class="col-md-6"> 
                                            <div class="slick-slide" data-slick-index="1" aria-hidden="true" style="width: 540px;" tabindex="-1">
                                              <div class="bs-overlay foto">
                                                  <input type="hidden" id="dthiddenmediaurl16_04_2024_1" value="http://cdn.plnnusantarapower.co.id/proxycors_media.php?b64url=aHR0cDovL3ByaW1lLnBsbm51c2FudGFyYXBvd2VyLmNvLmlkL2ZpbGVzL2Rva3VtZW50YXNpL2ltYWdlLzU2MTQ4ZmExNzQ1ODI2ZjU4ZTVjNTM0Y2EwNjQ1OGNiLmpwZw==" tabindex="-1">
                                                  <img onclick="vhrefimg(`16_04_2024_1`)" id="vhrefimg16_04_2024_1" alt="Owner Camp" src="http://cdn.plnnusantarapower.co.id/proxycors_media.php?b64url=aHR0cDovL3ByaW1lLnBsbm51c2FudGFyYXBvd2VyLmNvLmlkL2ZpbGVzL2Rva3VtZW50YXNpL2ltYWdlLzU2MTQ4ZmExNzQ1ODI2ZjU4ZTVjNTM0Y2EwNjQ1OGNiLmpwZw==">
                                                  <div class="bs-overlay-panel bs-overlay-background bs-overlay-top text-center text-uppercase">
...
/*    width: 40px;*/
  ...
  .area-galeri-project .slider-nav .slick-track .slick-slide {
  ...
  .area-galeri-project .slider-nav .slick-track .slick-slide img {
    padding: 0px;
    margin: 0 0;
    min-height: 100%;
    width: auto;
