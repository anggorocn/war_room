...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "DIREKTORAT_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
$set= new Crud();
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/master_direktorat_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/master_direktorat_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });

    $('#btnImport').on('click', function () {
        openAdd("app/index/master_direktorat_import");
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/direktorat_json/update_status/?reqId="+valinfoid+"&reqStatus="+reqStatus,
                    function(data){
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/direktorat_json/json?reqPencarian="+reqPencarian+"&reqStatus="+reqStatus;
    ...
    $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/direktorat_json/delete/?reqId="+valinfoid,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/direktorat_json/json";
