...
<script type="text/javascript">
    ...
    var indexfieldtahun= arrdata.length - 5;
    var indexfieldbulan= arrdata.length - 6;
    ...
    $("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/outlining_assessment_add?reqId="+valinfoid+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun;
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('program',pesan,function(r){
            if (r){
                $.getJSON("json-app/outlining_assessment_json/update_status/?reqId="+valinfoid+"&reqStatus="+reqStatus,
                    function(data){
    ...
    $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/outlining_assessment_json/delete/?reqId="+valinfoid,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
    ...
    $('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/outlining_assessment_json/json?reqPencarian="+reqPencarian+"&reqStatus="+reqStatus+"&reqDistrik="+reqDistrik+"&reqBlok="+reqBlok+"&reqUnitMesin="+reqUnitMesin+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&reqVstatus=<?=$reqVstatus?>";
    ...
    jQuery(document).ready(function() {
      var jsonurl= "json-app/outlining_assessment_json/json?reqVstatus=<?=$reqVstatus?>";
