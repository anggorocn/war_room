...
<script type="text/javascript">
  jQuery(document).ready(function($){
    ...
    $.ajax({
        url : 'json-api/KinerjaProyekAcn_json/highlightdetilcb?v=<?=$v?>',
        type : 'GET',
        dataType : 'text',
  ...
  function vhref(vinfoid)
  {
    ...
    var promises_inner = [];
    // console.log('dthiddenmediaurl'+vinfoid);
    // return false;
    $('[id^="dthiddenmediaurl'+vinfoid+'"]').each(function(){
      ...
      var promise_inner = $.Deferred();
      promises_inner.push(promise_inner);
      var s_url= "json-api/KinerjaProyekAcn_json/file_content?index="+infoid+"&reqUrl="+encodeURIComponent(vmediaurl);
    ...
    $('[id^="dthiddenmediaurl'+vinfoid+'"]').each(function(){
      ...
      $.ajax({'url': s_url, 'success': function(dataajax){
        ...
        dataajax= JSON.parse(dataajax);
        // console.log(dataajax);
        // console.log("#vhref"+vinfoid+infoid);
        
        // $("#vhrefimg16_12_2021_1").attr("src", "data:image/png;base64," + dataajax);
        $("#vhrefimg"+vinfoid+infoid).attr("src", "data:image/png;base64," + dataajax);

        // $("#vhref"+vinfoid+infoid).attr("href", vmediaurl);
        
        // $("#vhrefimg"+vinfoid+infoid).attr('data', dataajax);
