...
if($pg!='peta_pembangkit' && $pg!='kesiapan_pembangkit' && $pg!='kinerja_proyek'){
  ...
  $stylePerode='style="display:none"';
}
                ...
                <div id="navbar" class="navbar-collapse collapse">
                  <ul class="nav navbar-nav">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          function getmenubyparent($infoid, $arrMenu, $infolinkmodul)
                          {
                            ...
                            foreach ($arrayKey as $valkey => $indexkey) 
                            {
                              ...
                              ?>
                              <li class="<? if($pg == $infolink){?>active<? } ?>">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                      <?
                      if($apppagerolekode=="ADMIN" || $apppageroleid=="1")
                      {
                      ?>
                        <li>
                          <div class="area-logout pull-right" style="margin-right: 10px;"><a href="admin/index" style="background-color: #3933ff;">Halaman Admin <i class="fa fa-sign-in" aria-hidden="true"></i></a></div>
                        </li>
                      <?
                      }
                      ?>
                        <li>
                            <div class="area-periode" <?=$stylePerode?>>
                                Periode
                                <select id='bln'>
                                    <?
