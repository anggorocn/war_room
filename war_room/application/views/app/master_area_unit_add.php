...
$statement=" AND A.STATUS IS NULL  AND A.LIST_AREA_ID IN  
(
            ...
            $('#ff').form('submit',
            {
                ...
                success:function(data){
                    ...
                    if(reqId == 'xxx')
                        ...
                        $.messager.alertLink('Info', infoSimpan, 'info', "app/index/<?=$pgreturn?>_add?reqId="+reqId+"&reqDistrikId=<?=$reqDistrikId?>&reqBlok=<?=$reqBlok?>&reqUnitMesin=<?=$reqUnitMesinId?>");
                }
            });
