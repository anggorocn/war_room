...
$arrtabledata= array(
    ...
    , array("label"=>"Rating", "field"=> "RATING", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "PROGRAM_ITEM_ASSESSMENT_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);

$set= new Crud();
$statement=" AND KODE_MODUL ='0404'";
// $statement=" ";
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/master_program_item_assessment_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/master_program_item_assessment_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('program',pesan,function(r){
            if (r){
                $.getJSON("json-app/program_item_assessment_json/update_status/?reqId="+valinfoid+"&reqStatus="+reqStatus,
                    function(data){
    ...
    $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/program_item_assessment_json/delete/?reqId="+valinfoid,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
    ...
    $('#btnImport').on('click', function () {
        openAdd("app/index/master_program_item_assessment_import");
    });
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/program_item_assessment_json/json?reqPencarian="+reqPencarian+"&reqStatus="+reqStatus;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/program_item_assessment_json/json";
