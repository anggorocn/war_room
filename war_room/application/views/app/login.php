...
<html lang="en">
  <head>
    ...
    <title>Executive Dashboard - PLN Nusantara Power</title>
    <base href="<?=base_url();?>" />
...
<body  class="body-login" onload="display_ct()">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    <div class="logo-login slide-bottom">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="area-login">
                    <form class="form-signin row fade-in" action="login/action" method="post">                    
                        <div class="col-md-6">
                            <div class="area-gambar slide-right">
                        ...
                        <div class="col-md-6 padding-none">
                            <div class="area-form slide-left">
                                <span id='ct' ></span>
                                ...
                                <script type="text/javascript">
                                    ...
                                    function display_ct() {
                                        ...
                                        x1 = x1 + " <div class='jam'>" +  x.getHours( )+ ":" +  (x.getMinutes()<10?'0':'') + x.getMinutes() + ":" +  (x.getSeconds()<10?'0':'') + x.getSeconds() + "</div>";
                                ...
                                <!-- <div class="form-group row captcha">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="reqCapcha" autocomplete="off" id="reqCapcha" class="form-control" placeholder="Kode" maxlength="5" required>
                                    </div>
                                </div> -->
    ...
    <div class="copyright">
        <div class="fade-in">© 2023 PT PLN Nusantara Power. All rights reserved.</div>    
    </div>
