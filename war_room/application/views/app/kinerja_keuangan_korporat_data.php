                          ...
                          <div class="area-kelompok-keuangan wow fadeInDown" data-wow-delay="0.6s">
                            <div class="item">
                              ...
                              <div class="info-nilai hijau" id='field-0'>
                                ...
                                <div class="title" id='Textnilai-0' >s/d Des 2021</div>
                              </div>
                              <div class="data">
                                <table style="width:100%">
                                   <tr>
                                    <td id='Textnilai2-0'>s/d Des 2021  </td><td id='nilai2-0'></td>
                                  </tr>
                                  <tr>
                                    <td id='Textrkap2-0'>RKAP s/d Des 2022 </td><td id='rkap2-0'></td>
                                  </tr>
                                  <tr>
                                    <td id='Textnilai3-0'>s/d Nov 2021  </td><td id='nilai3-0'></td>
                                  </tr>
                                </table>
                              </div>
