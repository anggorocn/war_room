...
<body>
             ...
             <!--    <li class="nav-item">
                ...
                <li class="dropdown dropdown-info-user" style=" margin-right: 30px">
                    <a href="#" class="dropdown-toggle notification" data-toggle="dropdown" aria-expanded="false">
                        ...
                        <span class="badge" style="font-size: 11.5px;"><?=$jmlOutliningAll+$jmlRekomendasiAll?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-test" style="width: 100%;min-width: 250px; ">
                        ...
                        ?>
                            <li>
                                <div class="slimScrollDiv"  style="position: relative; width: auto; overflow: hidden; height: auto;">
                            ...
                            <li>
                                <div class="slimScrollDiv" >
                                    <ul class="menu" >
                                        ...
                                        <li style="border-bottom: 1px solid ;">
                                            <a href="app/index/outlining_assessment_rekomendasi?reqNotif=1&reqVstatus=0">
                                        ...
                                        <li style="border-bottom: 1px solid ;">
                                            <a href="app/index/outlining_assessment_rekomendasi?reqNotif=1&reqVstatus=1">
                                        ...
                                        ?>   
                                        <li style="border-bottom: 1px solid ;">
                                            <a href="app/index/outlining_assessment_rekomendasi?reqNotif=1&reqVstatus=10">
                                       ...
                                       <!--  <li style="border-bottom: 1px solid ;">
                                            <a href="app/index/outlining_assessment_rekomendasi?reqNotif=1&reqVstatus=20">
                                            <i class="fa fa-check text-green"></i>&nbsp; <?=$jmlStjRekomendasi?>  Disetujui
                                            </a>
                                        </li> -->
                                        ...
                                        <li style="border-bottom: 1px solid ;">
                                            <a href="app/index/outlining_assessment_rekomendasi?reqNotif=1&reqVstatus=30">
                                        ...
                                        <li style="border-bottom: 1px solid ;">
                                            <a href="app/index/outlining_assessment_rekomendasi?reqNotif=1&reqVstatus=90">
                ...
                <li class="nav-item" style=" margin-top: 10px">
                    <a class="nav-link logout" href="#"><i class="fa fa-question-circle" aria-hidden="true"></i>&nbsp; Help</a>
                </li>
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="margin-bottom: 0px !important;">
                    ...
                    <div class="info" style="min-height: 0px !important;">
                       <!--  <a href="#" class="d-block">
                        ...
                        <div class="jabatan"><?=$this->appusernama?> </div>
    ...
    function openAdd(pageUrl) {
        eModal.iframe(pageUrl, 'FIRST | PT PLN NP')
    }
    function openCabang(pageUrl) {
        eModalCabang.iframe(pageUrl, 'FIRST | PT PLN NP')
    }
    function closePopup() {
        eModal.close();
    }
