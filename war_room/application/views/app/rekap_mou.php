...
<style type="text/css">
  ...
  .area-datatabel .dataTables_wrapper.no-footer {
...
<script type="text/javascript">
  ...
  function RekapMou(tipe,search){
      ...
      thn= parseInt($("#thn").val());
      $.ajax({
          url : 'json-api/RekapMouNew_json/home?bln='+bln+'&thn='+thn+'&tipe='+tipe+'&search='+search,
          type : 'GET',
          dataType : 'text',
          success : function(text) {
            ...
            chart1.series[0].update({
                data: [
                    ['Perlu tindak lanjut', text['bddMerah']],
                    ['Berjalan', text['bddHijau']]
                ]}, false);
            chart1.redraw();
