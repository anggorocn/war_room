                            ...
                            <table id="" class="table table-bordered table-striped table-hovered" style="width: 100%;" >
                                <thead >
                                    <tr>
                                        ...
                                        <th class="text-center" style="width: 30%;">Status Approval</th>
                                    </tr>
                                </thead>
                                <tbody >
                                    <?
                                    ...
                                    foreach ($arrareadetil as $key => $value) 
                                    {
                                       ...
                                       $arrparam= ["ref_tabel"=>$pg, "ref_id"=>$value["OUTLINING_ASSESSMENT_REKOMENDASI_ID"]];
                                       $vappr= new libapproval();
                                       ...
                                       $datastatus= $vappr->listapprovalstatus($arrparam);
                                        ...
                                        <tr class="detil" >
                                            ...
                                            <td style="text-align: center"><label style="font-weight: normal !important;"><?=$value["KETERANGAN"]?></label></td>
                                            <td style="text-align: center"><label style="font-weight: normal !important;"><?=$reqStatusRekomendasiNama?></label></td>
                                            <td style="text-align: center"><label style="font-weight: normal !important;"><?=$tipe?></label></td>
                                            <td>
                                                <?
                                                if(!empty($detaildok))
                                                {
                            ...
                            <table class="table table-bordered table-striped table-hovered" style="width: 100%;"> 
                                <tbody >
                                    ...
                                    <tr>
                                        ...
                                        <td > 
                                           <input  class="easyui-datebox textbox form-control" <?=$readonlywo?>  name="reqRencanaEksekusi"  id="reqRencanaEksekusi" value="<?=$reqRencanaEksekusi?>"  style="width:100%" />
                                        </td>
                                    </tr>
                                    <tr>
...
if(check_vstatus ==20 && cekroleid==3 )
{
    $('#simpannew').show();
}

else if(check_vstatus ==30 && cekroleid==3 )
{
    $('#simpannew').show();
}
...
$('#reqBulan,#reqTahun').on('change', function() {
    ...
    // console.log(bulan);
    $("#distrikm").empty();
    $.getJSON("json-app/outlining_assessment_json/filter_rekomendasi?reqBulan="+bulan+"&reqTahun="+tahun+"&reqVstatus=<?=$reqVstatus?>",
    function(data){
