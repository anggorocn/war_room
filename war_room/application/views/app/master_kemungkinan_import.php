...
$link="app/loadUrl/app/kemungkinan_template";
?>
                         ...
                         <div class="card-body">
                            <div class="warning box" style="text-align: justify;font-size: 18px">
                                <ol>
                                    ...
                                    <li>Kolom <b>Peraturan ID</b> berformat <b>Angka/Integer</b>
                                    </li>
                                    <li>Kolom <b>Kode</b> harus unik dan tidak boleh ada spasi
                                    </li>
                                    <li>Kolom <b>Lebih Besar/Lebih Kecil </b> dan <b>bobot </b> berformat numeric
                                    </li>
                                </ol>
                            </div>
...
function submitForm(){
    $('#ff').form('submit',{
        url:'json-app/import_json/kemungkinan_template',
        onSubmit:function(){
        ...
        success:function(data){
            ...
            if(reqId == 'xxx')
                ...
                $.messager.alert('Info', infoSimpan ,null,function(){
                    top.location.href= "app/index/master_kemungkinan";
                });
        }
    });
}
