...
<script type="text/javascript">
 ...
 $('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/work_json/json_work_order?reqDistrikId=<?=$reqDistrikId?>&reqPencarian="+reqPencarian;
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json-app/work_json/json_work_order?reqDistrikId=<?=$reqDistrikId?>";
