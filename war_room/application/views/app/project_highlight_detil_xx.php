        ...
        <div class="row">
            <div class="col-md-12">
                <div class="area-breadcrumb pull-left">
                    ...
                    <li><a href="app/index/project_highlight">Highlight Proyek</a></li>
                    <!-- <li><a href="#">Summer 15</a></li> -->
                    <li>Highlight Proyek Detil</li>
                    </ul> 
                </div>
            </div>
            <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="header-detil">
                                ...
                                <div class="judul">
                                    <span class="ikon"><img src="images/icon-kesiapan-pembangkit.png"></span> Highlight Proyek Detil
                        ...
                        <div class="area-monitoring-proyek-akuisisi highlight-detil">
                          <div class="item item-highlight">
                            ...
                            <div class="inner">
                              ...
                              <div class="nilai" id='location_name'>
                              </div>
                          ...
                          <div class="item item-detil">
                            <div class="inner">
                              ...
                              <section class="cd-horizontal-timeline">
                                ...
                                <div class="events-content" id='temp_content'>
...
<script type="text/javascript">
  jQuery(document).ready(function($){
    ...
    // let timelineComponents['timelineWrapper'], timelineComponents['eventsWrapper'], timelineComponents['fillingLine'], timelineComponents['timelineEvents'], timelineComponents['timelineDates'], timelineComponents['eventsMinLapse'], timelineComponents['timelineNavigation'], timelineComponents['eventsContent'];
    // let timelineComponents['timelineWrapper']= timelineComponents['eventsWrapper'] = timelineComponents['fillingLine'] = timelineComponents['timelineEvents'] = timelineComponents['timelineDates'] = timelineComponents['eventsMinLapse'] = timelineComponents['timelineNavigation'] = timelineComponents['eventsContent'];

    $.ajax({
        url : 'json-api/KinerjaProyekAcn_json/highlightDetilold?v=<?=$v?>',
        type : 'GET',
        dataType : 'text',
    ...
    {      
      ...
      {
        $("#tanggalanggoro-2022-12-14").show();
        // string baseStr64= cbimg;
        // $("#imganggoro-2022-12-14").setAttribute('src', "data:image/jpg;base64," + baseStr64);
        // $("#imganggoro-2022-12-14").setAttribute('src', "data:image/jpg;base64," + cbimg);
        $("#imganggoro-2022-12-14").attr('src', 'data:image/jpeg;base64,' + base64encode(cbimg));
        // console.log(base64encode(cbimg));

        // $('#imganggoro-2022-12-14').attr("src",cbimg);
        // console.log(cbimg);
    ...
    */
    ...
    function updateContent(x) {
      y=$( ".clastdata" );
     console.log(y[0]['firstChild']['data']);
    }
</script>