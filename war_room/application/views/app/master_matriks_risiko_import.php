...
$link="app/loadUrl/app/matriks_risiko_template";
?>
                         ...
                         <div class="card-body">
                            <div class="warning box" style="text-align: justify;font-size: 18px">
                                <ol>
                                    ...
                                    <li>Kolom <b> Kode</b> Harus <b>unik</b> dan <b>tidak boleh ada spasi</b> 
                                    </li>
                                    <li>Kolom <b> ID</b> berformat <b>Angka/Integer</b>
                                    </li>
                                </ol>
                            </div>
...
function submitForm(){
    $('#ff').form('submit',{
        url:'json-app/import_json/matriks_risiko_template',
        onSubmit:function(){
        ...
        success:function(data){
            ...
            if(reqId == 'xxx')
                ...
                $.messager.alert('Info', infoSimpan ,null,function(){
                    top.location.href= "app/index/matriks_risiko";
                });
        }
    });
}
