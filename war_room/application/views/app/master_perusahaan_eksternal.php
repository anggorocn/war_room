...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "PERUSAHAAN_EKSTERNAL_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);

$set= new Crud();
$statement=" AND KODE_MODUL ='0104'";
$kode= $appuserkodehak;
...
<div class="col-md-12">
    <div class="judul-halaman"> Data Perusahaan</div>
            ...
            <div class="divfilter filterbaru"  >
                <div class="col-md-12" style="margin-bottom: 20px;" >
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control jscaribasicmultiple" id="reqKode" <?=$disabled?>  style="width:100%;" >
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/master_perusahaan_eksternal_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/master_perusahaan_eksternal_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });

    $('#btnImport').on('click', function () {
        openAdd("app/index/master_perusahaan_eksternal_import");
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/perusahaan_eksternal_json/update_status/?reqId="+valinfoid+"&reqStatus="+reqStatus,
                    function(data){
     ...
     $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/perusahaan_eksternal_json/delete/?reqId="+valinfoid,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/perusahaan_eksternal_json/json?reqPencarian="+reqPencarian+"&reqKode="+reqKode+"&reqStatus="+reqStatus;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/perusahaan_eksternal_json/json";
