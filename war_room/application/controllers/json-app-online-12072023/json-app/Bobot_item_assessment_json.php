...
class bobot_item_assessment_json extends CI_Controller
{
	...
	function add()
	{
		...
		$set = new BobotItemAssessment();
		$set->setField("BOBOT_ITEM_ASSESSMENT_ID", $reqId);
		$set->setField("KATEGORI_ITEM_ASSESSMENT_ID", ValToNullDB($reqKategoriId));
