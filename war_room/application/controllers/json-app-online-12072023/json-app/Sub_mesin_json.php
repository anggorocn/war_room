...
class sub_mesin_json extends CI_Controller
{
	...
	function json()
	{
		$this->load->model("base-app/SubMesin");
		...
		$statement=" AND A.DISTRIK_ID =".$reqDistrikId." AND A.BLOK_UNIT_ID =".$reqBlokUnitId." AND A.UNIT_MESIN_ID =".$reqUnitMesinId."";
		$sOrder = " ORDER BY A.SUB_MESIN_ID ASC";
	...
	function add()
	{
		...
		$set->setField("SUB_MESIN_ID", $reqId);
