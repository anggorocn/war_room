...
class App extends CI_Controller {
	...
	function __construct() {
		...
		$this->apppageroleid= $this->session->userdata("apppageroleid");
		$this->apppagerolekode= $this->session->userdata("apppagerolekode");
	...
	{
		$pg = $this->uri->segment(3, "home_tes");
		$reqId = $this->input->get("reqId");
		...
		$this->load->view('app/index_tes', $data);
	}
	...
	public function indexasli()
	{
		...
		$this->load->view('app/index_asli', $data);
	}
