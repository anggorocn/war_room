...
class KinerjaProyekAcn_json extends CI_Controller {
    ...
    function imgdt($b64url="")
    {
      $url = urldecode($b64url);
      $url= "aHR0cDovL3ByaW1lLnBsbm51c2FudGFyYXBvd2VyLmNvLmlkL2ZpbGVzL2Rva3VtZW50YXNpL2ltYWdlLzYwZTZhZTQzZWEyNWI0ZjQxODA3ODk2ZmQzMDIyOWZiLmpwZWc=";
      // echo $url;exit;
