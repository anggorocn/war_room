...
class Page_json extends CI_Controller
{
	...
	function json()
	{
		...
		$sOrder = " ORDER BY PENGGUNA_PAGE_HAK_ID ASC ";
	...
	function add()
	{
		...
		$set->setField("PENGGUNA_PAGE_HAK_ID", $reqId);
