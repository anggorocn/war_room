...
class konfirmasi_item_assessment_json extends CI_Controller
{
	...
	function add()
	{
		...
		// print_r($reqKonfirmasiItemAssessmentId);exit;

		$set = new KonfirmasiItemAssessment();
		$set->setField("KONFIRMASI_ITEM_ASSESSMENT_ID", $reqId);
		...
		if ($reqMode == "insert")
		{
			...
			$check = new KonfirmasiItemAssessment();
