...
class matriks_risiko_json extends CI_Controller
{
	...
	function add()
	{
		...
		$reqRisikoId= $this->input->post("reqRisikoId");
		$reqDampakId= $this->input->post("reqDampakId");
		$reqKemungkinanId= $this->input->post("reqKemungkinanId");
		$reqKode= $this->input->post("reqKode");

		$reqPeraturanId= $this->input->post("reqPeraturanId");

		// print_r($reqRisikoId);exit;

		$set = new MatriksRisiko();
		$set->setField("RISIKO_ID", $reqRisikoId);
		$set->setField("DAMPAK_ID", $reqDampakId);
		$set->setField("KEMUNGKINAN_ID", $reqKemungkinanId);
		$set->setField("MATRIKS_RISIKO_ID", $reqId);
		$set->setField("KODE", $reqKode);

		$set->setField("PERATURAN_ID", ValToNullDB($reqPeraturanId));
		...
		// {
		// 	echo "xxx***Peraturan harus diisi";exit;
		// }
